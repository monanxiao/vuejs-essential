...
export default {
  ...
  components: {
        ...
        if (!this.auth) {
          ...
          if (Array.isArray(comments)) {
            ...
            for (let comment of newComments) {
              ...
              // 这里删除了 uname 和 uavatar 的重新赋值，因为已经有这两个数据了// 将评论内容从 Markdown 转成 HTML
    ...
    },editComment(commentId, commentIndex) {// 编辑评论
              // 编辑器
